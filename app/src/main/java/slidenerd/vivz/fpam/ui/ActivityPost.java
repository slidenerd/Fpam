...
public class ActivityPost extends AppCompatActivity {
    ...
    void onCreateView() {
        ...
        mPost1.setProfilePicture("http://orig08.deviantart.net/a179/f/2014/026/3/3/breaking_bad_walter_white_facebook_profile_picture_by_ultimate_savage-d73ttlh.jpg");
        mPost2.setUserName("Ankush Deshpande");
        mPost2.setUpdatedTime("20 mins ago");
        mPost2.setProfilePicture("https://s-media-cache-ak0.pinimg.com/236x/b9/58/2d/b9582d806f57b4d8aab0655759d3cb34.jpg");
